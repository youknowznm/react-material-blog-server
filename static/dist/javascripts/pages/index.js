...
"use strict";
/* unused harmony export initGDSHeader */
/*
...
let initGDSHeader = function () {
    ...
    $header.on('mousedown', '.nav-item', function (evt) {
        ...
        if (!$targetBtn.hasClass('active') && !rippling) {
            ...
            */
            ...
            let targetIsAtRight = $navButtons.index($targetBtn) > $navButtons.index($currentBtn) ? true : false;
    ...
    function changeColorTheme($ele) {
        ...
        let pallete = ['red', 'yellow', 'blue', 'green', 'gray', 'silver'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_gds_header__ = __webpack_require__(0);
/*
index
*/
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_gds_header__["default"])();
