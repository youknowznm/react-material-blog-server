...
function initGDHeader() {
    ...
    var $window = (0, _jquery2.default)(window).scrollTop(0),
        ...
        $shadow = (0, _jquery2.default)('.gds-header-shadow');

    var $main = (0, _jquery2.default)('.main'),
        $fixedPanel = (0, _jquery2.default)('.fixed-panel');
    ...
    $window.on('scroll', function (evt) {
        ...
        // 浮动控件top调整
        var _h = $main.height() - 80;
        $fixedPanel.css('top', scTp + 300 > _h ? _h : scTp + 300);
    });
...
function initMdTag() {
    ...
    (0, _jquery2.default)('.md-tag ._input').on('focus', function () {
        ...
        forbidSymbolInput((0, _jquery2.default)(this));
    }).on('input', function () {
        forbidSymbolInput((0, _jquery2.default)(this));
        ...
        if (evt.keyCode === 13) {
            ...
            if (/\S/.test(val)) {
                ...
                $this.before((0, _jquery2.default)('<span class="tag"><span class="tag-content">' + val + '</span><i class="btn-remove"></i></span>'));
            }
        }
        // 字数验证
        var currentCount = $this.val().length;
...
var _mdInput = __webpack_require__(20);

var _mdInput2 = _interopRequireDefault(_mdInput);

var _mdTag = __webpack_require__(21);

var _mdTag2 = _interopRequireDefault(_mdTag);

var _mdTextarea = __webpack_require__(22);

var _mdTextarea2 = _interopRequireDefault(_mdTextarea);

var _mdButton = __webpack_require__(3);
...
(0, _jquery2.default)(function () {
    ...
    var $mdi = (0, _jquery2.default)('.md-input, .md-textarea');
    ...
    function setSubmitBtnStatus() {
        var allValid = true;
        $mdi.each(function () {
            var val = (0, _jquery2.default)(this).find('._input').val();
            if (/^\s*$/.test(val)) {
                allValid = false;
            }
        });
    ...
    $s_btn.click(function () {
        ...
        var title = encodeURIComponent((0, _jquery2.default)('._title ._input').val());
        var summary = encodeURIComponent((0, _jquery2.default)('._summary ._input').val());
        var content = encodeURIComponent((0, _jquery2.default)('._content ._input').val());
        var created = new Date().toString();
        var tags = '';
        (0, _jquery2.default)('._tags').find('.tag-content').each(function () {
            tags += '<&>' + (0, _jquery2.default)(this).text();
        });
