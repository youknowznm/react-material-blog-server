...
function initGDHeader() {
    ...
    $window.on('scroll', function (evt) {
        ...
        $s.css('top', 256 - scTp < 64 ? 64 : 256 - scTp);
        $rippleLayer.css('height', 192 - scTp < 0 ? 0 : 192 - scTp);
    });
...
module.exports = "data:image/png;base64,"
...
function initMdTag() {
    ...
    function initTag($mdtag) {
        var tagsData = $mdtag.data('md-tags');
        if ($mdtag.find('.tag').length > 0) {
            $mdtag.addClass('non-empty');
        }
        var $input = $mdtag.find('._input');
    ...
    (0, _jquery2.default)('.md-tag').each(function () {
        initTag((0, _jquery2.default)(this));
    });

    (0, _jquery2.default)('.md-tag ._input').on('focus', function () {
        var $this = (0, _jquery2.default)(this);
        var $mdtag = $this.parents('.md-tag');
        if ($this.val() === '') {
        ...
        var $this = (0, _jquery2.default)(this);
        var $mdtag = $this.parents('.md-tag');
        var $error = $mdtag.find('.error');
        var tags = $mdtag.find('.tag');
        ...
        if (evt.keyCode === 13) {
            ...
            if (/\S/.test(val)) {
                ...
                $this.before((0, _jquery2.default)('<span class="tag">' + val + '<i class="btn-remove"></i></span>'));
            }
        }
        // 字数验证
        var currentCount = $this.val().length;
        var currentCharCounter = $mdtag.find('.current');
        var maxCharCount = +$mdtag.find('.maximum').text();
        currentCharCounter.text(currentCount);
    });

    (0, _jquery2.default)('.md-tag').on('click', function () {
    ...
    (0, _jquery2.default)('.md-tag').on('click', '.btn-remove', function (evt) {
        var $tar = (0, _jquery2.default)(evt.target).parent('.tag');
...
var _mdTag = __webpack_require__(16);

var _mdTag2 = _interopRequireDefault(_mdTag);

var _mdTextarea = __webpack_require__(17);
...
(0, _jquery2.default)(function () {
    ...
    // 非空验证
    (0, _jquery2.default)('body').on('blur', '.md-input, .md-textarea', function () {
...
module.exports = "data:image/png;base64,"
